...
<p align="center">
  <img src="assets/banner.svg" alt="MLPlatformOps Banner" width="800"/>
</p>
...
**Live:** [https://launchmodel-demo.vercel.app](https://launchmodel-demo.vercel.app)

Shows the architecture, the inference console, and real
...
<table align="center">
  <tr>
    <td align="center" width="50%"><sub>Web console, real inference against the live FastAPI service</sub></td>
    <td align="center" width="50%"><sub>MLflow, real training run logged by train.py</sub></td>
  </tr>
  <tr>
    <td align="center" width="50%"><img src="assets/screenshots/console.png" width="380"/></td>
    <td align="center" width="50%"><img src="assets/screenshots/mlflow.png" width="380"/></td>
  </tr>
</table>

## Overview

MLPlatformOps packages the full lifecycle of a machine learning model:
...
<p align="center">
  <img src="assets/architecture.svg" alt="MLPlatformOps Architecture" width="700"/>
</p>
...
```bash
git clone https://github.com/Hamilas/MLPlatformOps
cd MLPlatformOps
cp .env.example .env
docker compose up
```
...
- **Web console** (`app/static/index.html`): dark "ops console" theme with a live inference form and endpoint browser, served at `/`
...
- **Kubernetes-ready**: Helm charts with HPA (2-10 replicas), ServiceMonitor, Ingress
- **CI/CD**: GitHub Actions builds & pushes images to GHCR, deploys on release
- **IaC**: Terraform modules for GKE Autopilot
